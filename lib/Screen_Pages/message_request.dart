...
class _MessageRequestState extends State<MessageRequest> {
  ...
  List list = [
    ...
    {"Name": "Hardik Pandeya", "image": "https://i.pinimg.com/originals/2e/31/a4/2e31a4fce6c52a98d518053d269d7eba.jpg"},
    {
    ...
    {"Name": "Nanami Kento", "image": "https://wallpaperaccess.com/full/5661539.png"},
    {"Name": "Ryomen Sukuna", "image": "https://i1.sndcdn.com/artworks-Ovrge2921kVbhGxA-m3FQYA-t500x500.jpg"},
    {"Name": "Vijay Thalapathy", "image": "https://static.toiimg.com/photo/101080781.cms"},
    {
      "Name": "Yash",
      "image":
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: GestureDetector(
        onTap: () {
          removeMsgUserCubit.DeleteAllReqUser(context).then(
            (value) {
              messageRequestCubit.GetAllMessageRequest();
            },
          );
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: AppColor.white, borderRadius: BorderRadius.circular(33), boxShadow: const [
            BoxShadow(
              color: Colors.grey,
              offset: Offset(
                0,
          ...
          child: Text(
            ...
            style: const TextStyle(
                fontSize: 17, fontWeight: FontWeight.w600, fontFamily: 'Roboto', color: Color(0xffFF0000)),
          ),
        ),
      ),
      body: SizedBox(
          ...
          children: [
            ...
            SafeArea(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Message requests'.tr(),
                        style: const TextStyle(fontSize: 25, fontFamily: 'Roboto', fontWeight: FontWeight.w600),
                      ),
                    ],
                  ),
                ),
                ...
                BlocBuilder<AllMessageRequestCubit, AllMessageRequestState>(
                  builder: (context, state) {
                    print(state);
                    if (state is AllMessageRequestSuccess) {
                      return Expanded(
                          child: messageRequestCubit.userMssageReq.data?.withoutConnect == null ||
                                  ...
                                  itemBuilder: (context, index) {
                                    return Dismissible(
                                        ...
                                        onDismissed: (direction) {
                                          removeMsgUserCubit.DeleteReqUser(context,
                                                  id: messageRequestCubit
                                                          .userMssageReq.data?.withoutConnect?[index].id ??
                                                      '')
                                              .then(
                                            (value) {
                                              messageRequestCubit.GetAllMessageRequest();
                                           ...
                                           image: messageRequestCubit.userMssageReq.data?.withoutConnect?[index].userImage ?? '', uid: messageRequestCubit.userMssageReq.data?.userId ?? '', id: messageRequestCubit.userMssageReq.data?.withoutConnect?[index].id ?? '',);
                                            ...
                                            String refresh =
                                              ...
                                              return ZIMKitMessageListPage(
                                                blockOrDeleteId:
                                                    messageRequestCubit.userMssageReq.data?.withoutConnect?[index].id ??
                                                        "",
                                                name: 'Request',
                                                conversationID:
                                                    messageRequestCubit.userMssageReq.data?.withoutConnect?[index].id ??
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  CachedNetworkImage(
                                                    imageUrl:
                                                        "${apis.baseurl}/${messageRequestCubit.userMssageReq.data?.withoutConnect?[index].userImage ?? ''}",
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          messageRequestCubit.userMssageReq.data?.withoutConnect?[index]
                                                                  .userName ??
                                                              '',
                                                          style: const TextStyle(
                                                              fontSize: 15,
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          decoration: const BoxDecoration(
                                                              shape: BoxShape.circle, color: AppColor.skyBlue
