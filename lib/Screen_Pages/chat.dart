...
*/
    ...
    ChatClient.getInstance.chatManager.addMessageEvent(
      ...
      ChatMessageEvent(
        onSuccess: (msgId, msg) {
          ...
          print("voice ===> $body");
          messageList.add(displayvoiceMessage(
            isSentMessage: true,
            thumbnail: body.remotePath.toString(),
            dispalname: body.displayName.toString(),
          ));
          setState(() {
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                            fontSize: 15, fontWeight: FontWeight.w600, fontFamily: 'Roboto', color: Color(0xffFF0000)),
                      ),
                    ),
                  ),
                  GestureDetector(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Accept'.tr(),
                        style: const TextStyle(
                            fontSize: 15, fontWeight: FontWeight.w600, fontFamily: 'Roboto', color: Color(0xff1D1D1D)),
                      ),
                    ),
                  ),
                ],
                                  ...
                                  Navigator.of(context).push(CupertinoDialogRoute(
                                      builder: (context) => CustomGalleryDisplay.instagramDisplay(
                                          ...
                                          galleryDisplaySettings: GalleryDisplaySettings(
                                            appTheme: AppTheme(primaryColor: Colors.black, focusColor: Colors.white),
                                          ),
                                            ...
                                            ChatClient.getInstance.chatManager.addMessageEvent(
                                              ...
                                              ChatMessageEvent(
                                                onSuccess: (msgId, msg) {
                                                  ...
                                                  setState(() {
                                                    scrollController
                                                        .jumpTo(scrollController.position.maxScrollExtent + 210);
                                                  });
                                                },
                                                onProgress: (msgId, progress) {
                                                  print(" ============================> $msgId");
                                  ...
                                  ChatClient.getInstance.chatManager.addMessageEvent(
                                    ...
                                    ChatMessageEvent(
                                      onSuccess: (msgId, msg) {
                                        ...
                                        displayfileMessage(
                                            body.remotePath.toString(), body.displayName.toString(), true);
                                  ...
                                  audioRecording
                                      ? GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: const BoxDecoration(
                                                image:
                                                    DecorationImage(image: AssetImage('assets/Images/recording.png'))),
                                          ),
                                        )
                                      : GestureDetector(
          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                  borderRadius: isSentMessage
                      ? const BorderRadius.only(
                          bottomLeft: Radius.circular(26), topRight: Radius.circular(26), topLeft: Radius.circular(26))
                      : const BorderRadius.only(
                          bottomRight: Radius.circular(26),
                          topRight: Radius.circular(26),
                          topLeft: Radius.circular(26)),
                        ...
                        child: // _controller.value.isInitialized
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: VideoPlayer(VideoPlayerController.network(thumbnail)..initialize()),
                            ),
                            const Center(
                              child: CircleAvatar(
  ...
  void displayfileMessage(final thumbnail, String dispalname, bool isSentMessage) {
    messageList.add(InkWell(
      onTap: () {
        ...
        Navigator.push(context, MaterialPageRoute(
          builder: (context) {
            return Pdfview(pdfUrl: thumbnail);
          },
        ));
      },
      child: Row(
            ...
            decoration: BoxDecoration(
                borderRadius: isSentMessage
                    ? const BorderRadius.only(
                        bottomLeft: Radius.circular(26), topRight: Radius.circular(26), topLeft: Radius.circular(26))
                    : const BorderRadius.only(
                        bottomRight: Radius.circular(26), topRight: Radius.circular(26), topLeft: Radius.circular(26)),
                color: isSentMessage ? AppColor.skyBlue : AppColor.gray),
            child: Padding(
              padding: EdgeInsets.symmetric(
                  horizontal: screenWidth(context, dividedBy: 40), vertical: screenHeight(context, dividedBy: 100)),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Image(
  ...
  Future Getdata() async {
    final result =
        await ChatClient.getInstance.chatManager.fetchHistoryMessages(conversationId: widget.id, pageSize: 50);
    setState(() {
      loading = true;
    });
    ...
    for (int i = 0; i < result.data.length; i++) {
      if (result.data[i].body.type == MessageType.TXT) {
        ...
        messageList.add(displayMessage(
          text: body.content,
          isSentMessage: result.data[i].from == widget.uid ? true : false,
        ));
      }
      ...
      if (result.data[i].body.type == MessageType.FILE) {
        ...
        displayfileMessage(
            body.remotePath, body.displayName.toString(), result.data[i].from == widget.uid ? true : false);
      }
...
class _displayvoiceMessageState extends State<displayvoiceMessage> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Row(
        mainAxisAlignment: widget.isSentMessage ? MainAxisAlignment.end : MainAxisAlignment.start,
        children: [
          Container(
            //alignment: Alignment.centerRight,
            margin: EdgeInsets.only(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.w500,
                        fontFamily: 'Roboto',
                        color: widget.isSentMessage ? AppColor.white : AppColor.dropdownfont),
                  ),
                  SizedBox(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
          ...
          children: [
            Flexible(
              child: Container(
                ...
                child: Padding(
                  padding: EdgeInsets.symmetric(
                      horizontal: screenWidth(context, dividedBy: 30), vertical: screenWidth(context, dividedBy: 50)),
                  child: Column(
                    crossAxisAlignment: widget.isSentMessage ? CrossAxisAlignment.end : CrossAxisAlignment.start,
                    children: [
        ...
        GestureDetector(
          onTap: () {
            translatLanguageCubit.TranslatLanguageService(array: widget.text, context: context).then(
              (value) {
          ...
          child: Padding(
            ...
            child: Text(
              tmsg ? "See Translation" : "See Original",
