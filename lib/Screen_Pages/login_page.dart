                    ...
                    children: [
                                ...
                                child: Container(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                    ...
                                    Text(
                                      "+$countryCodeSelect",
                                      style: TextStyle(
                                          fontSize: countryCodeSelect.length <= 3 ? 13 : 14,
                                          fontFamily: 'Roboto',
                      ...
                      Custom_textfield(context, show_icon: true, onPress: () {
                        setState(() {
                          ...
                          image: showpassword ? 'assets/Images/visibility_off.png' : 'assets/Images/visibility.png',
                          hint: 'Enter your password',
                          controller: _Password,
                          hidetext: showpassword,
                          readOnly: false),
                      Padding(
                        padding: EdgeInsets.only(top: screenWidth(context, dividedBy: 90)),
                            ...
                            child: Custom_botton(
                              ...
                              onTap: () async {
                                if (_Email.text.isEmpty) {
                                  ...
                                  loginCubit.LoginService(
                                      phoneNumber: _Email.text, otp: _Password.text, context: context);
                                }
                              },
                      ...
                      Row(children: <Widget>[
                        ...
                        const Text(
                          "OR",
                          style: TextStyle(color: Color(0xff888888), fontWeight: FontWeight.w400, fontFamily: 'Roboto'),
                        ),
                        Expanded(
                          child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: const TextStyle(
                                    color: Color(0xff888888), fontWeight: FontWeight.w400, fontFamily: 'Roboto'),
                              ),
                            ],
                          ),
                        ),
                                ...
                                Container(
                                  ...
                                  decoration: const BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                          image: AssetImage('assets/Images/facebook.png'), fit: BoxFit.fitHeight)),
                                ),
                                SizedBox(
