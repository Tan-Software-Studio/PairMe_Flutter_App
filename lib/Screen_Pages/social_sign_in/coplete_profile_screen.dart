...
class CompleteProfile extends StatefulWidget {
  ...
  bool isGoogleSignIn, isFacebookSignIn;

  CompleteProfile({super.key, required this.firstname, required this.lastname, required this.email, required this.isGoogleSignIn,required this.isFacebookSignIn});
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  custom_header(text: "Complete Profile"),
                  ...
                  }, image: popup ? 'assets/Images/Vector.png' : 'assets/Images/right_arrow.png', hint: 'Select Gender', controller: _gender, hidetext: false, readOnly: true),
                  popup
                      ? FadeInDown(
                          animate: true,
                          from: 7,
                          child: Container(
                            ...
                            decoration: BoxDecoration(color: AppColor.white, borderRadius: BorderRadius.circular(6), boxShadow: const [
                              BoxShadow(
                                color: Colors.grey,
                                offset: Offset(
                                  1,
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    const Text(
                                      "Female",
                                      style: TextStyle(fontSize: 12, color: Color(0xff303030), fontWeight: FontWeight.w400, fontFamily: 'Roboto'),
                                    )
                                  ],
                                ),
                                Row(
                  ...
                  Custom_textfield(context,
                      ...
                      onTap: () {
                        BottomPicker.date(
                          ...
                          titleStyle: TextStyle(fontSize: 15, fontFamily: 'Roboto', fontWeight: FontWeight.w500, overflow: TextOverflow.ellipsis, color: AppColor.black),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(6), color: AppColor.white, boxShadow: const [
                      BoxShadow(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          prefixIcon: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                                ...
                                Text(
                                  "+$countryCodeSelect",
                                  style: TextStyle(fontSize: countryCodeSelect.length <= 3 ? 13 : 14, fontFamily: 'Roboto', fontWeight: FontWeight.w400, color: AppColor.dropdownfont),
                                ),
                                const Icon(
                          ...
                          hintStyle: const TextStyle(color: Color(0xffB3B3B3), fontFamily: 'Roboto', fontSize: 14, fontWeight: FontWeight.w400)),
                    ),
                  ),
                  InkWell(
                    ...
                    child: Row(
                      children: [
                          ...
                          child: Center(
                            child: select
                                ? Container(
                                    ...
                                    decoration:
                                        BoxDecoration(borderRadius: BorderRadius.circular(3), image: const DecorationImage(image: AssetImage('assets/Images/check.png'), fit: BoxFit.fill)),
                                  )
                                : const SizedBox(),
                          ),
                        ),
                        ...
                        Text(
                          ...
                          style: TextStyle(fontWeight: FontWeight.w400, fontSize: 15, fontFamily: 'Roboto', color: select ? const Color(0xff303030) : const Color(0xffB3B3B3)),
                        )
                      ],
                    ),
                  ),
                      ...
                      onTap: () {
                        if (gender.isEmpty) {
                          ...
                          signUpCubit.signUpService(
                            ...
                            isFacebookSignIn: widget.isFacebookSignIn,
                          );
                        }
                      },
